...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
            ...
            when (it.itemId) {
                R.id.fragment_home -> {
                    if (MyongsikApplication.prefs.getUserCampus() == "Y") {
                        ...
                        navController.navigate(R.id.fragment_select_seoul)
                        return@setOnItemSelectedListener true
                    }
                }
        ...
        navController.addOnDestinationChangedListener { _, destination, _ ->
            if (destination.id == R.id.fragment_home || destination.id == R.id.fragment_search || destination.id == R.id.fragment_love
                || destination.id == R.id.fragment_select_home || destination.id == R.id.fragment_map || destination.id == R.id.fragment_select_seoul) {
