...
import com.myongsik.presentation.databinding.ItemRestaurantFoodBinding

//카카오 api 불러온 리사이클러뷰 아이템 어댑터
//검색화면 추천에서 쓰일 것 (10개 까지만 보여주기 때문에)
class SearchFoodAdapter(listener: OnSearchViewHolderClick) : ListAdapter<Restaurant, SearchFoodViewHolder>(
    BookDiffCallback
) {
